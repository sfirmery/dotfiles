...
# Full keyboard access for all controls (1 standard, 3 full)
...
# ctrl+tab and ctrl+shift+tab for switching tabs in Terminal.app
defaults write -app Terminal NSUserKeyEquivalents '{
	"Show Next Tab" = "^\U21e5";
	"Show Previous Tab" = "^$\U21e5";
}'

# set "Move focus to next window" shortcut to cmd+<
...
defaults write com.apple.universalaccess com.apple.custommenu.apps -array "NSGlobalDomain" "com.apple.Terminal"
